...
## Өөр chat-д зэрэгцээ хийгдсэн ажил — UX QA + контентын шилжvvлэлт (2026-09-07..13)

Widget builder ↔ backend холболтоос ТУСДАА (дээрх A–E чек-лист хараахан
эхлээгvй), доорх 5 commit өөр чиглэлээр ирсэн:

1. **Дэлгэрэнгvй/тvvх/мэдээ хуудас** болон **API лавлах/баримтын хуудас,
   нийтлэг vг**-ийг admin-аар удирдагдахаар (`content.json`-д бvртгэж)
   шилжvvлэв — өмнө нь эдгээр хуудасны текст хатуу код дотор байсан.
2. **`ux-qa-persona` субагент vvсгэв** — жирийн хэрэглэгчийн нvдээр
   порталыг (ялангуяа admin/виджет удирдлагыг) тестэлж, ойлгомжгvй/
   төвөгтэй хэсгvvдийг олж, бvтэцтэй санал гаргадаг QA агент. Дуудах
   нь: шинэ build бvрд, эсвэл "UX тест хий" гэсэн хvсэлтийн дараа.
3. Энэ агентаар тестэлж **T1–T5 олдворыг хааж, 3 шинэ олдвор бvртгэв**
   (backlog-д хадгалагдсан — дэлгэрэнгvйг git log-оос үз:
   `dbf672c UX QA backlog-ийг бvртгэв`).
4. **5 засвар** хийв: худал мэдэгдэл, англи vг, товчлол, файлын зам,
   тайлбаргvй тэмдэгт — эдгээр нь ux-qa-persona-гийн олсон UX согогууд.
...
гэсэн шинэ бvлгvvд нэмэгдсэн — эдгээр нь ерөнхий ажлын журам, зөвхөн
widget builder-т хамаарахгvй.

**Холбоо:** дээрх backend integration ажил ба энэ UX QA ажил ХОЁР ТУСДАА
урсгал. Шинэ chat нээхдээ аль ажлыг vргэлжлvvлэхээ (backend холболт уу,
эсвэл цаашдын UX QA цикл vv) эхэндээ тодруулах хэрэгтэй.
