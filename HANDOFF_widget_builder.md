...
- **Сонгосон шийдэл**: шинэ домэйн + FortiGate дээр шууд NAT/port-forward.
  - Домэйн: ~~`etransport.data.gov.mn`~~ → **`portal.mrt.gov.mn`** (2026-09-17
    A record `103.17.108.199` болсон, 8.8.8.8/1.1.1.1/дотоод DNS-ээр
    баталгаажсан). Тэр өдөр 80/443 гаднаас `Connection refused` байсан.
...
## Өөр chat-д зэрэгцээ хийгдсэн ажил — UX QA + контентын шилжүүлэлт (2026-09-07..13)

Widget builder ↔ backend холболтоос ТУСДАА (дээрх A–E чек-лист хараахан
эхлээгүй), доорх 5 commit өөр чиглэлээр ирсэн:

1. **Дэлгэрэнгүй/түүх/мэдээ хуудас** болон **API лавлах/баримтын хуудас,
   нийтлэг үг**-ийг admin-аар удирдагдахаар (`content.json`-д бүртгэж)
   шилжүүлэв — өмнө нь эдгээр хуудасны текст хатуу код дотор байсан.
2. **`ux-qa-persona` субагент үүсгэв** — жирийн хэрэглэгчийн нүдээр
   порталыг (ялангуяа admin/виджет удирдлагыг) тестэлж, ойлгомжгүй/
   төвөгтэй хэсгүүдийг олж, бүтэцтэй санал гаргадаг QA агент. Дуудах
   нь: шинэ build бүрд, эсвэл "UX тест хий" гэсэн хүсэлтийн дараа.
3. Энэ агентаар тестэлж **T1–T5 олдворыг хааж, 3 шинэ олдвор бүртгэв**
   (backlog-д хадгалагдсан — дэлгэрэнгүйг git log-оос үз:
   `dbf672c UX QA backlog-ийг бүртгэв`).
4. **5 засвар** хийв: худал мэдэгдэл, англи үг, товчлол, файлын зам,
   тайлбаргүй тэмдэгт — эдгээр нь ux-qa-persona-гийн олсон UX согогууд.

CLAUDE.md-д мөн **"Тестийн мөчлөг"** (5 алхамт unit→регресс→хос
шалгалт→цуврал→commit дараалал) ба **"Ажлын горим"** (архитектур
нэгтгэх → судалгаа → autonomous сайжруулалт → зөрчил дээр л асуух)
гэсэн шинэ бүлгүүд нэмэгдсэн — эдгээр нь ерөнхий ажлын журам, зөвхөн
widget builder-т хамаарахгүй.

**Холбоо:** дээрх backend integration ажил ба энэ UX QA ажил ХОЁР ТУСДАА
урсгал. Шинэ chat нээхдээ аль ажлыг үргэлжлүүлэхээ (backend холболт уу,
эсвэл цаашдын UX QA цикл үү) эхэндээ тодруулах хэрэгтэй.
