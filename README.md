...
Нийтлэл нь шуурхай харагдац, git нь бүртгэл. Өөрчлөлтийг **байнгын** болгож
хянахын тулд `Экспортлох` дарж татсан JSON-оо репод хуулж commit хийнэ —
эс тэгвэл файл ба нийтлэл хоёр цаг хугацаанд зөрөх болно.
